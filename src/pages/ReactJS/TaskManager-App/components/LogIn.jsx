        ...
        <div className="w-full">
            ...
            <div className="relative -top-[450px] min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="text-center text-2xl font-bold pt-5">
                    LogIn <br />
                    <span className="text-sm font-normal">Don't have an acount, <Link className="text-[rgb(240,46,101)]" to="/reactjs/taskManager/register">Register</Link></span>
                </div>
                        ...
                        <div className="border-[rgb(39,41,58)] bg-[rgb(39,41,58)] py-8 px-4 shadow sm:rounded-lg sm:px-10">
                            <form className="space-y-6" action="#" method="POST">
                                ...
                                <div>
                                    <button
                                    type="submit"
                                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[rgb(240,46,101)] hover:bg-{rgba(240,46,101,0.5)}"
                                    >
                                    Log In
                                    </button>
                                </div>
