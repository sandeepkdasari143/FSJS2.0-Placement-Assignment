...
const Sidebar = () => {
    return (
        <div className='trasition-all duration-500 linear min-h-[92vh] flex justify-center basis-[15%] border-r border-pink-300 dark:border-[rgb(39,41,58)] bg-[rgb(245,245,251)] dark:bg-[rgb(20,20,31)]'>
